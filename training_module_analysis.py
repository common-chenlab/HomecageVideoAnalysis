...
class TrainingModuleAnalysis():
    ...
    def run_coat_recognition(self, frame):
        ...
        mousecoatpredicted, confidence = self.mousecoatrecognition.run_inference(frame = coatframe)
    ...
    def run_analysis(self, BATCH_OF_FRAMES, edge_case = 0):
        ...
        if init_successful == False: # unable to successfully initialize trial
    ...
    def run(self):
        ...
        while True:
            ...
            if ret:
                ...
                if (led_status == 1) and (self.corrupt_status == False):
    ...
    def process_trial_data(self):
        ...
        self.TRIALDATA['timestamp_offset_list'] = [self.ocr.get_timestamp_offset(init = self.TRIALDATA['timestamp_per_frame'][0], curr = ocr_timestamp) 
            for ocr_timestamp in self.TRIALDATA['timestamp_per_frame']]
